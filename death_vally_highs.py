...
death_valley_high = Data(filename,index_high)
death_valley_low = Data(filename,index_low)
dates = death_valley_low.dates()
highs = death_valley_high.temperatures
lows = death_valley_low.temperatures
